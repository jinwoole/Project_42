...
/*   Updated: 2022/04/10 16:02:59 by jinwoole         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../push_swap.h"

int	index_biggest(t_list *stack_a)
{
	int	biggest;
	int	i;
	int	j;
...
int	index_smallest(t_list *stack_a)
{
	int	smallest;
	int	i;
	int	j;
...
void	operation(t_list *stack_a, t_list *stack_b)
{
	int	first_content;
	int	second_content;
...
void	five_sort(t_list *stack_a, t_list *stack_b)
{
	...
	i = 1;
	lstsize = 5;
	biggest = index_biggest(stack_a);
	smallest = index_smallest(stack_a);
	while (lstsize)
	{
